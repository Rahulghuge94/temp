...
(function (global, factory) {
  ...
  defaultExport$2.prototype.drawChart = function drawChart (chart, type, data, options) {
    ...
    // let ops = JSON.parse(JSON.stringify(chart.options));
    // chartOptions.options.scales = {...chartOptions.options.scales, ...ops.scales};
    // chartOptions.options.plugins = {...chartOptions.options.plugins, ...ops.plugins};
    chartOptions.options = merge(chartOptions.options, chart.options);
